# Feature Request: Remove Unnecessary sudo Usage in tuya-convert
...
1. **Virtual Environment Problems**: `sudo` resets environment variables, breaking virtual environment activation
...
- Upstream #1167: Ubuntu non-docker deps issue (virtual environment broken by sudo)
- Upstream #1159: Python environment error (PEP 668 compliance)
...
**Labels**: `enhancement`, `security`, `refactoring`, `good-first-issue` (for investigation phase)
